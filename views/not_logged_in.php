...
<html >
  <head>
    ...
    <style>
      ...
      html {
        height: 100%;
        background: radial-gradient(ellipse at bottom, #345071 0%, #481f3b 100%);
        overflow: hidden;
      }
...
<body>
   ...
   <div class='flex-container'>
      <div class='flex-item'>
         <a class="btn btn-primary btn-large theme-login" href="javascript:;">LOG IN</a>
         <div class="theme-popover">
              ...
              <div class="theme-popbod dform">
                    ...
                    <form class="theme-signin" name="loginform" action="index.php" method="post">
                         <ol>
                              <li><strong>Username：</strong><input id="login_input_username" class="login_input ipt" type="text" name="user_name" size="20" /></li>
                              <li><strong>Password：</strong><input id="login_input_password" class="login_input ipt" type="password" name="user_password" size="20" /></li>
                              <li><input class="btn-subimt" type="submit" name="login" value=" LOG IN " /></li>
                         </ol>
                    </form>
              </div>
         </div>
...
?>
      ...
      <div class='flex-item'>
         <a class="btn btn-primary btn-large theme-signup" href="javascript:;">SIGN UP</a>
         <div class="theme-pop">
              <div class="theme-poptit">
                   <a href="javascript:;" title="close" class="close">×</a>
                   <h3>SHARING IS CARING</h3>
              ...
              <div class="theme-popbod dform">
                    <form class="theme-signin" name="loginform" action="register.php" method="post">
                      <ol>
                        <li><strong>Username：</strong><input id="login_input_username" class="login_input ipt" type="text" name="user_name" size="20" easyform="length:4-16;char-normal;real-time;" message="The user name must be 4-16 characters including letters or number" easytip="disappear:lost-focus;theme:blue;" ajax-message="Username already exists!"/></li>
                        <li><strong>Password：</strong><input id="login_input_password_new" class="login_input ipt" type="password" name="user_password_new" size="20" easyform="length:6-16;" message="Password must be 6-16 characters" easytip="disappear:lost-focus;theme:blue;"/></li>
                        <li><strong>Confirm<br>Password：</strong><input id="login_input_password_repeat" class="login_input ipt" type="password" name="user_password_repeat" size="20" easyform="length:6-16;equal:#psw1;" message="Must match the previous entry!" easytip="disappear:lost-focus;theme:blue;" /></li>
                         <li><strong>Email：</strong><input id="login_input_password_new" class="login_input ipt" type="email" name="user_email" easyform="email;real-time;" message="Email format should be correct!" easytip="disappear:lost-focus;theme:blue;" ajax-message="This email address has been registered, please change it!"/>
